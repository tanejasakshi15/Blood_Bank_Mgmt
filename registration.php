...
$nameErr =$emailErr =$contactErr=$countryErr=$cityErr=$stateErr=$listErr=$fkErr=$addressErr= "";
$name = $email = $contact = $country = $state = $city =$list= $fk = $address= "";
 $fk="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // 2    Validate gender
    if(empty($_POST["fk"]   )){
        $fkErr = 'Please choose your gender.';
    }
	...
	if(empty($_POST["list"] ))
	$listErr='Please select your blood group';
    ...
    if(empty($_POST["state"])){
        $stateErr = 'Please choose your state.';
    }
	
	  // 8    Validate city
    if(empty($_POST["city"])){
        $cityErr = 'Please choose your city.';
    }
...
$small=$_POST["state"];
  ...
  if(!$nameErr && !$emailErr && !$contactErr && !$cityErr && !$listErr && !$fkErr && !$addressErr)
    {
         // connect to server 
         $con = mysqli_connect("localhost", "root", "", "mydb") or die("Error " . mysqli_error($con));
    
        $insert = mysqli_query($con,"INSERT INTO donors (gender,name, email,contact,city,address,bg,country,state) VALUES ('$f','$n', '$e' , '$cont','$ci','$a','$b','$large','$small')");  
	 ...
	 {
	 echo 'Please insert all the required fields';
	 }	
...
<div id="ib">
  ...
  <a href="#"><i class="fa fa-search">About us</i></a> 
  <a href="#"><i class="fa fa-envelope">Contact us</i></a> 
  <a href="#"><i class="fa fa-globe">Services</i></a>
  <a href="#"><i class="fa fa-user">Admin</i></a> 
</div>	   

<div id="icon-bar2">
  <a href="#" class="aa" ><i class="fa fa-user">&nbspDonor Registration &nbsp <font color="gray">/</font></i></a> 
  <a href="#" class="bb" ><i class="fa fa-bed">  Need Blood &nbsp <font color="gray">/</font> &nbsp </i></a> 
 <?php echo "<a href=\"search.php\" class=\"cc\"><i class=\"fa fa-search\">Search Donor</i></a>"; ?>
</div>
	   
<div class="heading">
<center> <i class="fa fa-user">&nbsp&nbsp<b><font face="verdana" style="font-size:14px">JOIN &nbsp AS &nbsp BLOOD&nbsp DONOR</font></b></i></center>
</div>
...
<div class="register">
	 <form action="registration.php"   method="post">
	       ...
	       <p>
         <label for="inputName">Name:<font class="error"><sup>*</sup></font></label>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
         <input type="text" class="input1" name="name" id="inputName" placeholder="Donor's name" value="<?php echo $name; ?>">
         <span class="error"><?php echo $nameErr; ?></span>
        </p>
        <p>
            <label for="inputEmail">Gender:<font class="error"><sup>*</sup></font></label>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <input type="radio"  name="fk" value="female"  id="inputGender" >Female
			<input type="radio"  name="fk" value="male"    id="inputGender" >Male
			<input type="radio"  name="fk" value="others"  id="inputGender" >Others 
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
            <span class="error"><?php echo $fkErr; ?></span>
        </p>
      
	  <p>
            <label for="inputBg">Blood Group:<font class="error"><sup>*</sup></font></label>
            <select name="list">
		...
		<p>
            ...
            <label for="inputEmail">Email:<font class="error"><sup>*</sup></font></label>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text" class="input1" name="email" id="inputEmail" placeholder="enter your email" value="<?php echo $email; ?>">
            <span class="error"><?php echo $emailErr; ?></span>
        </p>
       
		
		<p>
            <label for="inputName">Contact:<font class="error"><sup>*</sup></font></label>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" class="input1" name="contact" placeholder="xxx-xxx-xxxx" id="inputContact" value="<?php echo $contact; ?>">
            <span class="error"><?php echo $contactErr; ?></span>
        </p>
		
		<p>
            <label for="inputName">Country:<font class="error"><sup>*</sup></font></label>
        ...
        <p>
            <label for="inputName">State:<font class="error"><sup>*</sup></font></label>
		...
		<p>
           <label for="inputName">City:<font class="error"><sup>*</sup></font></label>
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
            <input type="text" class="input1" name="city" placeholder="your city" id="inputCity" value="<?php echo $city; ?>">
...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
           <textarea name="address" style="font-family:arial" placeholder="your full address" id="inputAddress" rows="6" cols="40"><?php echo $address; ?></textarea>
            <span class="error"> <?php echo $addressErr; ?></span>
        </p>
		
<BR><BR>
		<button class="button"  type="submit" name="submitform"><span>Register</span></button>
